...
Homomorphic evaluations of _approximate computation_, which can be useful for machine learning, can be [done more efficiently](https://eprint.iacr.org/2016/421).
